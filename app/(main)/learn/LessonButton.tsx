    ...
    >
      <div
        ...
        style={{
          ...
          marginTop: isFirst && !isCompeleted ? 60 : 24,
        }}
      >
        {current ? (
          <div className="h-[102px] w-[120]px relative">
            <div className="absolute -top-6 left-2.5 px-3 py-2.5 border-2 font-bold uppercase text-green-500 bg-white rounded-xl animate-bounce tracking-widez-10 z-20">
              start
